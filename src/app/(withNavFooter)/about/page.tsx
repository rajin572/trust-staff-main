...
const cardsData: ICardData[] = [
  ...
  },
  {
    ...
    description:
      "With a team boasting over 200 years of combined experience in  recruitment, interviewing, and employment management, Trust Staff Ltd  delivers precision, reliability, and peace of mind. We take pride in  helping you find the right candidate for your project—whether it's a  full-time or temporary placement.",
    subDescription:
