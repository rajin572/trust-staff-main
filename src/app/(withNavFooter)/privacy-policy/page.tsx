        ...
        <div className="my-20">
          ...
          <div className="border-b-4 border-secondary-color px-8 py-10 text-center">
            ...
            <p className="text-xl text-gray-900">
              Trust Staff Ltd Privacy Policy (UK GDPR Compliant)
            </p>
          ...
          <div className="px-8 py-10 space-y-10">
            ...
            <section>
              ...
              <div className="text-gray-900 leading-relaxed space-y-4">
                <p>
                  Some of our service providers may store or process data outside the United Kingdom. In such cases, Trust Staff Ltd ensures that adequate safeguards are implemented to comply with UK GDPR standards. These safeguards may include the use of countries deemed to offer adequate protection under UK law, the implementation of International Data Transfer Agreements, or the adoption of Standard Contractual Clauses approved by the Information Commissioner&apos;s Office (ICO). We require all overseas partners to apply strong security measures and ensure the lawful handling of data transferred internationally. Users may contact us at any time for more information about the specific safeguards applied to international transfers.
                </p>
                <p>
                  Trust Staff Ltd remains fully responsible for all data transferred to or processed by third parties and ensures that such transfers occur only when necessary and compliant with applicable legal requirements. We continuously monitor our suppliers to verify ongoing compliance with these standards.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="text-gray-900 leading-relaxed space-y-4">
                <p>
                  If you have questions about this Privacy Policy, require assistance with your personal data, or wish to exercise any of your rights under the UK GDPR, you may contact Trust Staff Ltd using the information below. We aim to respond to all enquiries as quickly as possible and provide clear guidance regarding your rights, our data-handling practices, and any aspects of this Policy that require clarification.
                </p>
                <div className="bg-gray-50 border border-gray-300 rounded-lg p-6">
                  <h3 className="text-lg font-semibold text-gray-900 mb-3">Data Controller:</h3>
                  <p className="text-gray-900">
                    <span className="font-semibold">Trust Staff Ltd</span><br />
                  ...
                  <p className="text-gray-900 mt-3">
                    <span className="font-semibold">Email:</span> support@truststaff.ai
                  </p>
                </div>
