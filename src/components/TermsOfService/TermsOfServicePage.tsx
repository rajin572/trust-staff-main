                ...
                <div className="">
                    ...
                    <div className="border-b-4 border-secondary-color px-8 py-10 text-center">
                        ...
                        <p className="text-xl text-gray-900">
                            Terms & Conditions Governing the Provision of HR Management Services by Trust Staff Ltd
                        </p>
                    </div>
                    ...
                    <div className="px-8 py-10 space-y-10">
                        ...
                        <section>
                            ...
                            <div className="text-gray-900 leading-relaxed space-y-4">
                                <p>
                                    This Master Service Agreement forms the comprehensive contractual framework governing the provision of subscription-based HR management services by Trust Staff Ltd, a company duly incorporated in England and Wales and operating from 124–128 City Road, London, EC1V 2NX. This Agreement outlines the rights, obligations, and responsibilities of both parties in relation to the use of Trust Staff Ltd.&apos;s digital HR platform, administrative support solutions, and associated service features.
                                </p>
                                <p>
                        ...
                        <section>
                            ...
                            <div className="space-y-3 text-gray-900">
                                <div className="border-l-4 border-secondary-color pl-4 py-2">
                                    <p><span className="font-semibold">Company:</span> means Trust Staff Ltd, its directors, employees, authorised agents, and permitted assigns.</p>
                                </div>
                                <div className="border-l-4 border-secondary-color pl-4 py-2">
                                ...
                                <div className="border-l-4 border-secondary-color pl-4 py-2">
                                    <p><span className="font-semibold">Workers:</span> means individuals engaged solely by the Employer. Workers are not employees, contractors, agents, or representatives of Trust Staff Ltd.</p>
                                </div>
                                <div className="border-l-4 border-secondary-color pl-4 py-2">
                        ...
                        <section>
                            ...
                            <div className="space-y-6">
                                <div>
                                    ...
                                    <p className="text-gray-900 mb-3">Trust Staff Ltd reserves the right to suspend or terminate the Employer’s access to the
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900">
                                        ...
                                        and any proprietary technologies—belong exclusively to Trust Staff Ltd. The Employer
                            ...
                            <div className="space-y-6">
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900">
                                        ...
                                        Agreement without the prior written consent of the Company. Trust Staff Ltd may
                                ...
                                <div>
                                    ...
                                    <p className="text-gray-900">
                                        ...
                                        Trust Staff Ltd at the address listed in Section 1, or sent via an approved electronic
